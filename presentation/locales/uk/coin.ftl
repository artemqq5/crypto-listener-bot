...
COIN-DIFFERENCE-SET = 🔢 Встановіть різницю ціни для <b>{$coin}</b> від вартості в <b>{$price}$</b> (від 0.00001 до 1000) або в процентному співвідношенні (1% - 100%) із знаком % в кінці:
COIN-DIFFERENCE-VALUE_ERROR = ⚠️ Формат має бути числом від 0.00001 до 1000 або 1% - 100% із знаком %, спробуйте ще раз:
